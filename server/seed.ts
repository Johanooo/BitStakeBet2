...
const seedBookmakers = [
  ...
  },
  {
    ...
    slug: "betpanda",
    domain: "betpanda.io",
    shortDescription: "No KYC crypto casino with 100% bonus up to 1 BTC",
    description: "Betpanda offers a seamless no-KYC gambling experience with zero fees and no limits. Features 6,000+ games and 10% weekly wager-free cashback.",
    foundedYear: 2022,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "NO_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://betpanda.io/?ref=cryptobookies",
    trustScoreOverride: 90,
    payoutSpeed: "Instant",
    minDeposit: "$0",
    supportLiveChat: true,
    featured: true,
    pros: ["No KYC required", "Zero fees", "Weekly cashback"],
    cons: ["Newer platform"],
  },
  {
    name: "Fortune Jack",
    ...
    shortDescription: "Established crypto casino with 500% deposit bonus",
    description: "FortuneJack is a well-established crypto casino offering massive bonuses with only 10x wagering, 5,000 free spins, and a $1M monthly promo pool.",
    foundedYear: 2014,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "NO_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://fortunejack.com/?ref=cryptobookies",
    trustScoreOverride: 88,
    payoutSpeed: "Instant",
    minDeposit: "$20",
    supportLiveChat: true,
    featured: true,
    pros: ["Huge welcome bonus", "Low wagering", "VIP friendly"],
    cons: ["Interface can be busy"],
  },
  {
    name: "Bitcasino.io",
    slug: "bitcasino",
    domain: "bitcasino.io",
    shortDescription: "Premium crypto casino with unparalleled VIP benefits",
    description: "Bitcasino.io offers a premium gambling experience with 100% bonus up to 1,500 USDT and exclusive VIP perks.",
    foundedYear: 2014,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "LIGHT_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://bitcasino.io/?ref=cryptobookies",
    trustScoreOverride: 87,
    payoutSpeed: "< 10 mins",
    minDeposit: "$10",
    supportLiveChat: true,
    featured: true,
    pros: ["Premium VIP program", "Fast payouts", "Great game selection"],
    cons: ["Casino only"],
  },
  {
    name: "Bety",
    slug: "bety",
    domain: "bety.com",
    shortDescription: "Fast crypto casino with 280% bonus up to €12,000",
    description: "Bety offers 10,000+ games with 280% welcome bonus, 150 free spins, no KYC and fast withdrawals.",
    foundedYear: 2023,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "NO_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://bety.com/?ref=cryptobookies",
    trustScoreOverride: 85,
    payoutSpeed: "Instant",
    minDeposit: "$10",
    supportLiveChat: true,
    featured: false,
    pros: ["Huge game library", "No KYC", "Fast withdrawals"],
    cons: ["No sportsbook"],
  },
  {
    name: "Sportbet.one",
    slug: "sportbet-one",
    domain: "sportbet.one",
    shortDescription: "Decentralized sportsbook with 125% bonus",
    description: "Sportbet.one is a decentralized betting platform offering 125% bonus up to $1,000 with 10x rollover and instant withdrawals.",
    foundedYear: 2019,
    licenseName: "Decentralized",
    licenseJurisdiction: "N/A",
    kycLevel: "NO_KYC" as const,
    sportsbook: true,
    casino: true,
    esports: true,
    affiliateUrl: "https://sportbet.one/?ref=cryptobookies",
    trustScoreOverride: 84,
    payoutSpeed: "Instant",
    minDeposit: "$1",
    supportLiveChat: true,
    featured: false,
    pros: ["Decentralized", "Low rollover", "Instant payouts"],
    cons: ["Smaller game selection"],
  },
  {
    name: "7Bit Casino",
    slug: "7bit",
    domain: "7bitcasino.com",
    shortDescription: "Award-winning crypto casino with 325% bonus",
    description: "7Bit Casino offers a 325% welcome pack up to 5 BTC with 250 free spins, weekly cashback up to 20%, and exclusive tournaments.",
    foundedYear: 2014,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "LIGHT_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://7bitcasino.com/?ref=cryptobookies",
    trustScoreOverride: 86,
    payoutSpeed: "< 10 mins",
    minDeposit: "$20",
    supportLiveChat: true,
    featured: false,
    pros: ["Established since 2014", "Great bonuses", "Weekly cashback"],
    cons: ["No sportsbook"],
  },
  {
    name: "Bets.io",
    slug: "bets-io",
    domain: "bets.io",
    shortDescription: "Crypto casino with 250% welcome bonus",
    description: "Bets.io offers 250% welcome bonus up to 1 BTC with 250 free spins, featuring 700+ games and no mandatory KYC.",
    foundedYear: 2021,
    licenseName: "Mwali License",
    licenseJurisdiction: "Mwali",
    kycLevel: "LIGHT_KYC" as const,
    sportsbook: true,
    casino: true,
    esports: false,
    affiliateUrl: "https://bets.io/?ref=cryptobookies",
    trustScoreOverride: 83,
    payoutSpeed: "Fast",
    minDeposit: "$10",
    supportLiveChat: true,
    featured: false,
    pros: ["Great welcome bonus", "Growing platform", "Sports and casino"],
    cons: ["Newer platform"],
  },
  {
    name: "Mega Dice",
    slug: "megadice",
    domain: "megadice.com",
    shortDescription: "Telegram-native crypto casino with 200% bonus",
    description: "Mega Dice offers 200% bonus up to 1 BTC with 50 free spins and a sports free bet. Features 24+ language support.",
    foundedYear: 2023,
    licenseName: "Curacao eGaming",
    licenseJurisdiction: "Curacao",
    kycLevel: "NO_KYC" as const,
    ...
    casino: true,
    esports: false,
    affiliateUrl: "https://megadice.com/?ref=cryptobookies",
    trustScoreOverride: 84,
    payoutSpeed: "Instant",
    minDeposit: "$20",
    supportLiveChat: true,
    featured: true,
    pros: ["Telegram integration", "Great bonuses", "Anonymous play"],
    cons: ["Newer platform"],
  },
];
